        ...
        */
        "flash" => [
            ...
            "success" => [
                ...
                "user_group_add_success"               => "Project added with success.",
                "user_group_delete_success"            => "Project deleted with success.",
                ...
                // group
                "group_edit_success"                   => "Project edited succesfully.",
                "group_delete_success"                 => "Project deleted succesfully.",
            ...
            "error"   => [
                // user
                "user_group_not_found"       => "Project not found.",
