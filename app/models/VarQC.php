...
class VarQC extends Eloquent {
	...
	static public function getQCByPatientID($patient_id, $case_id, $type="dna")
    {
        ...
        Log::info("select v.*,s.exp_type, s.library_type, s.tissue_cat from var_qc v, samples s where v.sample_id=s.sample_id and v.patient_id = '$patient_id' and v.case_id='$case_id' and v.type='$type'");
        return VarQC::getQC($var_qcs, $type);
