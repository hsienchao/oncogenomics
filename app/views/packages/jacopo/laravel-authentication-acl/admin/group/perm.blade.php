...
<div class="form-group">
    ...
    <div class="form-group">
        @if(! $group->exists)
        <span class="text-danger"><h5>You need to create a project first.</h5></span>
        @endif
    </div>
{{Form::close()}}
...
@endforeach
@elseif($group->exists)
<span class="text-warning"><h5>There is no permission associated to the project.</h5></span>
@endif
