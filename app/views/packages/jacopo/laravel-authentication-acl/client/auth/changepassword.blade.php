    ...
    <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
        <div class="panel panel-info">
            <div class="panel-heading">
                <h3 class="panel-title">Change your password to {{Config::get('laravel-authentication-acl::app_name')}} Pub</h3>
            </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            {{Form::label('password', 'Please enter a new password with at least 6 alphanumeric characters: ')}}
                            ...
                            <br />
                             <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                {{Form::password('confirmpass', ['id' => 'confirmpass', 'class' => 'form-control', 'placeholder' => 'Confirm password', 'required', 'autocomplete' => 'off'])}}
                            </div>
                        </div>
                    </div>
                </div>
